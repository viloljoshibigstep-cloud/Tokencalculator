            ...
            >
              <div className="col-span-4 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <div className="truncate font-medium text-[var(--tx-hi)]">{p.full_name || p.email.split("@")[0]}</div>
              ...
              <div className="col-span-2">
                <span
                  className={
                    p.role === "admin"
                      ? "rounded-md bg-[var(--bg-300)] px-2 py-0.5 text-[11px] font-medium text-[var(--ink)]"
              ...
              <div className="col-span-2 flex items-center justify-end gap-2 text-right font-semibold text-[var(--tx-hi)]">
